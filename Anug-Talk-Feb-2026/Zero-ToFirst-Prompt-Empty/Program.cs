...
//Step 4: Add two NuGet packages (Azure.AI.OpenAI + Microsoft.Agents.AI.OpenAI) 
//                               [Note that all AI Packages are pre-release]

//Step 5: Create an AzureOpenAI Client

//Step 6: On the client create a ChatClient (defining the model to use)
//        and convert it to a Microsoft Agent Framework 'ChatClientAgent'
//        (or the more generic AIAgent)
